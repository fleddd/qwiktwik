    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-charcoal border border-white/5 p-6 rounded-3xl flex flex-col justify-between relative overflow-hidden">
            ...
            {user.role === "USER" && (
                <div className="bg-charcoal border border-white/5 rounded-3xl p-5 flex flex-col md:flex-row items-center justify-between gap-5 relative overflow-hidden mt-6">
            ...
            {/* БЛОК ВІДГУКУ */}
            {!myReview && (
                <div className="bg-charcoal border border-white/5 rounded-3xl p-5 flex flex-col md:flex-row items-center justify-between gap-5 relative overflow-hidden mt-4">
