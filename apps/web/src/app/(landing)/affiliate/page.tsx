    ...
    return (
        <div className="min-h-screen pt-28 md:pt-36 pb-24 bg-[#050505] text-white">
            <div className="max-w-5xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="mb-20">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                ...
                                <div key={i} className="bg-[#131316] border border-white/5 rounded-3xl p-8 flex flex-col items-start hover:border-white/10 transition-colors">
                ...
                <FadeIn delay={0.2}>
                    <div className="bg-[#131316] border border-white/5 rounded-3xl p-8 md:p-12 shadow-2xl mb-20">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                            ...
                            <div className="bg-[#0a0a0c] border border-white/5 rounded-2xl p-8 text-center flex flex-col justify-center items-center h-full">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="px-6 py-3 rounded-lg bg-[#131316] border border-white/10 text-white text-sm font-bold hover:bg-white/5 transition-all w-full"
                                >
                                    Open Form
                                </a>
                            </div>
                    ...
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                <details key={i} className="group bg-[#131316] border border-white/5 rounded-2xl">
